...
export const UI: Dict = {
  ...
  'ob.miss.depositMin': { en: 'a deposit of at least the minimum (see above)', it: 'un deposito almeno pari al minimo (vedi sopra)' },
  'ob.pwdAgain': { en: 'For security we never store it readable — please type it again.', it: 'Per sicurezza non la conserviamo in chiaro — inseriscila di nuovo.' },
  'ob.rejected.fix': { en: 'Only fix what is mentioned above — everything else is already filled in.', it: 'Correggi solo quanto indicato sopra — il resto è già compilato.' },
