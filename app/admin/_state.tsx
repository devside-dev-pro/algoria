...
export function useAdminState() {
  ...
  const [bcAudience, setBcAudience] = useState<'pending' | 'live' | 'stalled'>('live');
  ...
  const sendBroadcast = async () => {
    ...
    const who = bcAudience === 'pending' ? 'the members whose account is in the QUEUE (pending)' : bcAudience === 'stalled' ? 'everyone who picked a broker but NEVER submitted their MT details (the biggest drop-off — 245 people on 17/09)' : 'ALL live + paused members';
